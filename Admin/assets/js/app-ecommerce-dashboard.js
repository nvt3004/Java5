...
(function () {
  ...
  d = null !== d && new ApexCharts(d, c1).render();

  var d = document.querySelector("#activityChart"),
    c2 = {
      ...
      fill: {
        type: "gradient",
        gradient: { shade: t, shadeIntensity: 0.8, opacityFrom: 0.8, opacityTo: 0.25, stops: [0, 85, 100] },
      },
  ...
  d = null !== d && new ApexCharts(d, c2).render();

  var d = document.querySelector("#profitChart"),
    c3 = {
      series: [
        { data: [58, 28, 50, 80] },
        { data: [50, 22, 65, 72] },
  ...
  d = null !== d && new ApexCharts(d, c3).render();

  var d = document.querySelector("#expensesChart"),
    c4 = {
  ...
  d = null !== d && new ApexCharts(d, c4).render();

  var d = document.querySelector("#totalIncomeChart"),
    c5 = {
      chart: {
        height: 250,
        type: "area",
      ...
      fill: {
        type: "gradient",
        gradient: { shade: t, shadeIntensity: 0.8, opacityFrom: 0.7, opacityTo: 0.25, stops: [0, 95, 100] },
      },
      ...
      d = null !== d && new ApexCharts(d, c5).render();
    
      var d = document.querySelector("#performanceChart"),
        c6 = {
          series: [
            { name: "Customer", data: [26, 29, 31, 40, 29, 24] },
            { name: "Purchases", data: [30, 26, 24, 26, 24, 40] },
          ],
          chart: {
            height: 270,
            type: "radar",
            toolbar: { show: !1 },
            dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 6, left: 0, blur: 6, color: "#000", opacity: 0.14 },
          },
      ...
      d = null !== d && new ApexCharts(d, c6).render();
    
      var d = document.querySelector("#conversionRateChart"),
        c7 = {
          chart: { height: 80, width: 140, type: "line", toolbar: { show: !1 }, dropShadow: { enabled: !0, top: 10, left: 5, blur: 3, color: config.colors.primary, opacity: 0.15 }, sparkline: { enabled: !0 } },
          markers: {
            size: 6,
            colors: "transparent",
      ...
      d = null !== d && new ApexCharts(d, c7).render();
    
      var d = document.querySelector("#expensesBarChart"),
        c8 = {
          series: [
      ...
      d = null !== d && new ApexCharts(d, c8).render();
      ...
      var d = document.querySelector("#totalBalanceChart"),
        c9 = {
          ...
          chart: {
            ...
            parentWidthOffset: 0,
            type: "line",
            dropShadow: { enabled: !0, top: 10, left: 5, blur: 3, color: config.colors.warning, opacity: 0.15 },
            toolbar: { show: !1 },
          },
          dataLabels: { enabled: !1 },
          ...
          markers: {
            ...
            strokeColors: "transparent",
            strokeWidth: 4,
            discrete: [{ fillColor: config.colors.white, seriesIndex: 0, dataPointIndex: 5, strokeColor: config.colors.warning, strokeWidth: 8, size: 6, radius: 8 }],
            hover: { size: 7 },
          },
      ...
      d = null !== d && new ApexCharts(d, c9).render();
    })();
