...
$(function () {
    ...
    if (n.length) {
            ...
            columnDefs: [
                {
                    ...
                    targets: 0,
                    render: function (e, t, a, s) { return ""; }
                },
                {
                    targets: 2,
                ...
                },
                {
                    ...
                    render: function (e, t, a, s) {
                        var n = a.customer,
                            r = a.email,
                            o = a.avatar;
                        return '<div class="d-flex justify-content-start align-items-center order-name text-nowrap"><div class="avatar-wrapper"><div class="avatar me-2">' +
                            (o ? '<img src="' + assetsPath + "img/avatars/" + o + '" alt="Avatar" class="rounded-circle">' :
                                ...
                                (o = (((o = (n = a.customer).match(/\b\w/g) || []).shift() || "") + (o.pop() || "")).toUpperCase()) + "</span>") +
                            '</div></div><div class="d-flex flex-column"><h6 class="m-0"><a href="pages-profile-user.html" class="text-body">' + n + '</a></h6><small class="text-muted">' + r + "</small></div></div>";
                    }
                },
                {
                    targets: 5,
                ...
                },
                {
                    ...
                    render: function (e, t, a, s) {
                        var n = a.method,
                            a = a.method_number;
                        return "paypal_logo" == n && (a = "@gmail.com"),
                            '<div class="d-flex align-items-center text-nowrap"><img src="' + assetsPath + "img/icons/payments/" + n + '.png" alt="' + n + '" class="me-2" width="16"><span><i class="bx bx-dots-horizontal-rounded"></i>' + a + "</span></div>";
                    }
                },
                {
                    targets: -1,
            ...
            buttons: [
                {
                    ...
                    text: '<i class="bx bx-export me-1"></i>Xuất',
                    buttons: [
                        {
                            extend: "print",
                            ...
                            exportOptions: {
                                ...
                                format: {
                                    body: function (e, t, a) {
                                        var s;
                                        return e.length <= 0 ? e :
                                            (e = $.parseHTML(e), s = "", $.each(e, function (e, t) {
                                                void 0 !== t.classList && t.classList.contains("order-name") ? s += t.lastChild.firstChild.textContent :
                                                    void 0 === t.innerText ? s += t.textContent : s += t.innerText;
                                            }), s);
                                    }
                                }
                            },
            ...
            responsive: {
                details: {
                    display: $.fn.dataTable.Responsive.display.modal({
                        header: function (e) { return "Details of " + e.data().customer; }
                    }),
                    type: "column",
        ...
        // Thêm thẻ select tùy chỉnh
        let customSelect = `
                <label for="customSelect" class="ms-3">
                    <select id="customSelect" class="form-select form-select-sm">
                        <option value="day">Ngày</option>
                        <option value="month">Tháng</option>
                        <option value="year">Năm</option>
                    </select>
                </label>`;
        $(".dataTables_length").append(customSelect);

        // Xử lý sự kiện thay đổi của thẻ select tùy chỉnh
        $('#customSelect').on('change', function () {
            let value = $(this).val();
            // Thực hiện hành động theo giá trị đã chọn
            console.log('Selected value:', value);
            // Ví dụ: có thể gọi hàm để lọc dữ liệu theo ngày, tháng hoặc năm
        });
    }
